...
//        break;
//      case 1://获取电量
//        byte[] token = CaptureActivity.getCatrueActivity().getToken();
...
//        break;
//      case 2://开锁
//        sendDataBytes = new byte[]{0x05, 0x01, 0x06, SampleGattAttributes.password[0], SampleGattAttributes.password[1], SampleGattAttributes.password[2], SampleGattAttributes.password[3], SampleGattAttributes.password[4], SampleGattAttributes.password[5], this.token[0], this.token[1], this.token[2], this.token[3], 0x00, 0x00, 0x00};
