...
//      int width = screenResolution.x * 3 / 5;  //设置框宽大小（默认值）
//
//
//
...
//      }
//      int height = screenResolution.y * 3 / 5; //设置框高大小(默认)
//
//
//
...
//
//
//      int leftOffset = (screenResolution.x - width) / 2; //设置框离左边的大小(默认)
//     int topOffset = (screenResolution.y - height) / 2; //设置框离顶端的大小（默认）
...
//      framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
     // framingRect = new Rect(leftOffset, topOffset, leftOffset + 500, topOffset + 500);
      ...
      try {
        ...
        ToastUtils.showMessage("请检查相机权限");
      }
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
  ...
  public void flashHandler(){
    try {
      ...
      ToastUtils.showMessage("未检测到闪光灯");
    }
