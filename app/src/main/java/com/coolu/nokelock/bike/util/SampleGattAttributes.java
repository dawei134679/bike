...
public class SampleGattAttributes {
    ...
    public static final UUID bltServerUUID = UUID.fromString("0000fee7-0000-1000-8000-00805f9b34fb");//蓝牙锁的service
    public static final UUID beaconServerUUID = UUID.fromString("0000FBCA-0000-1000-8000-00805f9b34fb");//信标的service
