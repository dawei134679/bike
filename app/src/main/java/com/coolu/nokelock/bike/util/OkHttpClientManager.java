...
import com.fitsleep.sunshinelibrary.utils.SDCardUtils;
...
//                .hostnameVerifier(new TrustAllHostnameVerifier())
                .sslSocketFactory(new SSL(trustAllCert), trustAllCert)//2
...
//        Request request = buildPostRequest(url, jsonObject);
    ...
    private Request buildPostRequest(String url, JSONObject jsonObject) {
        Logger.i("OkHttp3","发送:"+jsonObject.toString());
